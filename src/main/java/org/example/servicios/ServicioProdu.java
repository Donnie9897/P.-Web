...
public class ServicioProdu extends DBService<Producto> {
    private static ServicioProdu instance;

    private ServicioProdu(){
        super(Producto.class);
    }

    public static ServicioProdu getInstance(){
        if(instance == null){
            instance = new ServicioProdu();
        }
        return instance;
    }
